...
//llz add encrypt entity
#define PJMEDIA_PKG_LEN 4096
typedef struct pjmedia_encrypt_t {
	unsigned char session_key[128];
	int session_key_len;
	char suite[32];
	/** Encrypt's "virtual" function table. */
