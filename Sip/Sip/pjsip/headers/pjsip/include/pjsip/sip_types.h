...
typedef struct pjsip_encrypt_op {
	int(*decode_sip_msg)(const unsigned char* in, int len, unsigned char* out, int* out_len);
	int(*encode_sip_msg)(const unsigned char* in, int len, unsigned char* out, int* out_len);
	int(*decode_sip_stream)(const unsigned char* in, int len, unsigned char* out, int* out_len, unsigned char* key, int key_len);
	int(*encode_sip_stream)(const unsigned char* in, int len, unsigned char* out, int* out_len, unsigned char* key, int key_len);
	int(*set_ouyu_param)(int type, unsigned char* value, unsigned short* value_len);
	int(*need_update_idrc)(int flag);
    int(*need_get_config)(void);
}pjsip_encrypt_op;
//llz end pjsip_encrypt_op
