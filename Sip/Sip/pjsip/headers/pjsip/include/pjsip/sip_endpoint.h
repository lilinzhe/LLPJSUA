...
/* llz add idrc opreation */
PJ_DECL(void) pjsip_set_encrypt_op(pjsip_endpoint* endpt, pjsip_encrypt_op* op);
PJ_DECL(pjsip_encrypt_op*) pjsip_get_encrypt_op(pjsip_endpoint* endpt);
/* llz add end idrc opreation */
